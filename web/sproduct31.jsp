<%-- 
    Document   : sproduct31
    Created on : Jul 13, 2022, 11:10:02 PM
    Author     : Andreas PC
--%>
...
<body>
    ...
    <section id="prodetails" class="section-p1">
        <div class="single-pro-image">
            <img src="img/products/tro15/1.png" width="100%" id="MainImg" alt="">
            <div class="small-img-group">
                <div class="small-img-col">
                    <img src="img/products/tro15/1.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/products/tro15/2.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/products/tro15/3.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/products/tro15/4.png" width="100%" class="small-img" alt="">
                </div>
            </div>
        </div>
        ...
        <div class="single-pro-details">
            ...
            <h2>Light Beige Pull-on Short</h2>
            <h3>$99</h3>
            <select>
            ...
            <Span>Shorts in a linen and viscose weave. High waist with covered elastication and a small frill trim, and discreet pockets in the side seams.</Span>
        </div>
    </section>
