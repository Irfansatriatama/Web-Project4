<%-- 
    Document   : sproduct9
    Created on : Jul 13, 2022, 11:07:35 PM
    Author     : Andreas PC
--%>
...
<body>
    ...
    <section id="prodetails" class="section-p1">
        <div class="single-pro-image">
            <img src="img/products/shirt9/1.png" width="100%" id="MainImg" alt="">
            <div class="small-img-group">
                <div class="small-img-col">
                    <img src="img/products/shirt9/1.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/products/shirt9/2.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/products/shirt9/3.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/products/shirt9/4.png" width="100%" class="small-img" alt="">
                </div>
            </div>
        </div>
        ...
        <div class="single-pro-details">
            ...
            <Span>CONSCIOUS CHOICE Blouse in a softly draping weave. Small frilled collar with narrow ties and a V-shaped opening at the front, and long, wide raglan sleeves with narrow, covered elastication at the cuffs.
            </Span>
        </div>
    </section>
    ...
    <section id="product1" class="section-p1">
        ...
        <div class="pro-container">
            <div class="pro" onclick="window.location.href='sproduct16.jsp'">
                <img src="img/products/shirt16/1.png" alt="">
                <div class="des">
                    <span>FAE</span>
                    <h5>Hello kitty T-Shirt</h5>
                </div>
            </div>
            <div class="pro" onclick="window.location.href='sproduct15.jsp'">
                <img src="img/products/shirt15/1.png" alt="">
                <div class="des">
                    <span>FAE</span>
                    <h5>Dark Grey Checked Jacket</h5>
                </div>
            </div>
            <div class="pro" onclick="window.location.href='sproduct12.jsp'">
                <img src="img/products/shirt12/1.png" alt="">
                <div class="des">
                    <span>FAE</span>
                    <h5>Blue Floral Dress</h5>
                </div>
            </div>
