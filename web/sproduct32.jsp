<%-- 
    Document   : sproduct32
    Created on : Jul 13, 2022, 11:10:06 PM
    Author     : Andreas PC
--%>
...
<body>
    ...
    <section id="prodetails" class="section-p1">
        <div class="single-pro-image">
            <img src="img/products/tro16/1.png" width="100%" id="MainImg" alt="">
            <div class="small-img-group">
                <div class="small-img-col">
                    <img src="img/products/tro16/1.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/products/tro16/2.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/products/tro16/3.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/products/tro16/4.png" width="100%" class="small-img" alt="">
                </div>
            </div>
        </div>
        ...
        <div class="single-pro-details">
            ...
            <h2>Light Pink Bermuda Short</h2>
            <h3>$99</h3>
            <select>
            ...
            <Span>Knee-length shorts in woven fabric with a zip fly and high waist with hook-and-eye fasteners. Diagonal side pockets, decorative welt back pockets, and wide, straight legs with creases.</Span>
        </div>
    </section>
