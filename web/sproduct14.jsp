<%-- 
    Document   : sproduct14
    Created on : Jul 13, 2022, 11:08:04 PM
    Author     : Andreas PC
--%>
...
<body>
    ...
    <section id="prodetails" class="section-p1">
        <div class="single-pro-image">
            <img src="img/products/shirt14/1.png" width="100%" id="MainImg" alt="">
            <div class="small-img-group">
                <div class="small-img-col">
                    <img src="img/products/shirt14/1.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/products/shirt14/2.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/products/shirt14/3.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/products/shirt14/4.png" width="100%" class="small-img" alt="">
                </div>
            </div>
        </div>
        ...
        <div class="single-pro-details">
            ...
            <h2>Light Blue Striped Long-sleeved Top</h2>
            <h3>$69</h3>
            <select>
            ...
            <Span>Long-sleeved top in soft cotton jersey with a round neckline.</Span>
        </div>
    </section>
