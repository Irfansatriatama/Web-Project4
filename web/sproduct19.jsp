<%-- 
    Document   : sproduct19
    Created on : Jul 13, 2022, 11:08:24 PM
    Author     : Andreas PC
--%>
...
<body>
    ...
    <section id="prodetails" class="section-p1">
        <div class="single-pro-image">
            <img src="img/products/tro3/1.png" width="100%" id="MainImg" alt="">
            <div class="small-img-group">
                <div class="small-img-col">
                    <img src="img/products/tro3/1.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/products/tro3/2.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/products/tro3/3.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/products/tro3/4.png" width="100%" class="small-img" alt="">
                </div>
            </div>
        </div>
        ...
        <div class="single-pro-details">
            ...
            <h2>White Relaxed Fit Trouser</h2>
            <h3>$89</h3>
            <select>
            ...
            <Span>Trousers in a cotton weave with covered elastication and a drawstring at the waist. Zip fly and button, side pockets, a coin pocket and welt back pockets. Relaxed Fit – a fit with good room for movement creating a comfortable, relaxed silhouette.
            </Span>
        </div>
    </section>
