<%-- 
    Document   : catalog
    Created on : Jul 13, 2022, 11:15:28 PM
    Author     : Andreas PC
--%>
...
<body>
    ...
    <section id="page-header" class="shop-header">        
        <h2>#StayAtHome</h2>      
        <p>CHOOSE THE OPTION YOU WANT</p>
    </section>

    <section id="product1" class="section-p1">        
        <div class="pro-container">
            <div class="pro" onclick="window.location.href='shirt.jsp'">
                <img src="img/catalog/Shirt.png" alt="">
                <div class="tx">
                    <h2>Shirt</h2>                
                </div>
            </div>
            <div class="pro" onclick="window.location.href='trouser.jsp'">
                <img src="img/catalog/Trouser.png" alt="">
                <div class="tx">
                    <h2>Trouser</h2>                
                </div>
            </div>
            <div class="pro" onclick="window.location.href='accessories.jsp'">
                <img src="img/catalog/Accessories.png" alt="">
                <div class="tx">
                    <h2>Accessories</h2>                
                </div>
            </div>
            <div class="pro" onclick="window.location.href='list.jsp'">
                <img src="img/catalog/Custom.png" alt="">
                <div class="tx">
                    <h2>Personal Info</h2>                
                </div>
            </div>           
