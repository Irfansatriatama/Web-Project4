<%-- 
    Document   : sproduct23
    Created on : Jul 13, 2022, 11:08:43 PM
    Author     : Andreas PC
--%>
...
<body>
    ...
    <section id="prodetails" class="section-p1">
        <div class="single-pro-image">
            <img src="img/products/tro7/1.png" width="100%" id="MainImg" alt="">
            <div class="small-img-group">
                <div class="small-img-col">
                    <img src="img/products/tro7/1.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/products/tro7/2.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/products/tro7/3.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/products/tro7/4.png" width="100%" class="small-img" alt="">
                </div>
            </div>
        </div>
        ...
        <div class="single-pro-details">
            ...
            <Span>Shorts in sweatshirt fabric made from a cotton blend with an elasticated, drawstring waist, side pockets, an open back pocket and raw, roll-edge hems.</Span>
        </div>
    </section>
