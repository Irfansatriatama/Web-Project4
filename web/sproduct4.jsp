<%-- 
    Document   : sproduct4
    Created on : Jul 13, 2022, 11:07:03 PM
    Author     : Andreas PC
--%>
...
<body>
    ...
    <section id="prodetails" class="section-p1">
        <div class="single-pro-image">
            <img src="img/products/shirt4/1.png" width="100%" id="MainImg" alt="">
            <div class="small-img-group">
                <div class="small-img-col">
                    <img src="img/products/shirt4/1.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/products/shirt4/2.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/products/shirt4/3.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/products/shirt4/4.png" width="100%" class="small-img" alt="">
                </div>
            </div>
        </div>
        ...
        <div class="single-pro-details">
            ...
            <h2>Relaxed Fit Patterned Resort Pink Shirt</h2>
            <h3>$59</h3>
            <select>
            ...
            <Span>CONSCIOUS CHOICE Short-sleeved shirt in a patterned viscose weave with a resort collar, French front and a yoke at the back. Dropped shoulders, a chest pocket and straight-cut hem. Relaxed Fit – a straight fit with good room for movement creating a comfortable, relaxed silhouette.</Span>
        </div>
    </section>
