<%-- 
    Document   : sproduct27
    Created on : Jul 13, 2022, 11:09:40 PM
    Author     : Andreas PC
--%>
...
<body>
    ...
    <section id="prodetails" class="section-p1">
        <div class="single-pro-image">
            <img src="img/products/tro11/1.png" width="100%" id="MainImg" alt="">
            <div class="small-img-group">
                <div class="small-img-col">
                    <img src="img/products/tro11/1.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/products/tro11/2.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/products/tro11/3.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/products/tro11/4.png" width="100%" class="small-img" alt="">
                </div>
            </div>
        </div>
        ...
        <div class="single-pro-details">
            ...
            <h2>Mint Green Velour Trouser</h2>
            <h3>$99</h3>
            <select>
            ...
            <Span>CONSCIOUS Trousers in soft velour. High waist with covered elastication and a drawstring, discreet pockets in the side seams and wide, straight legs.</Span>
        </div>
    </section>
