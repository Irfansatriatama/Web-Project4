<%-- 
    Document   : sproduct15
    Created on : Jul 13, 2022, 11:08:08 PM
    Author     : Andreas PC
--%>
...
<body>
    ...
    <section id="prodetails" class="section-p1">
        <div class="single-pro-image">
            <img src="img/products/shirt15/1.png" width="100%" id="MainImg" alt="">
            <div class="small-img-group">
                <div class="small-img-col">
                    <img src="img/products/shirt15/1.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/products/shirt15/2.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/products/shirt15/3.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/products/shirt15/4.png" width="100%" class="small-img" alt="">
                </div>
            </div>
        </div>
        ...
        <div class="single-pro-details">
            ...
            <h2>Dark Grey Checked Jacket</h2>
            <h3>$69</h3>
            <select>
            ...
            <Span>CHOICE Oversized jacket in woven fabric with notch lapels, a one-button fastening at the front, a chest pocket and jetted front pockets with a flap. Lined.</Span>
        </div>
    </section>
