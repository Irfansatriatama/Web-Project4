<%-- 
    Document   : sproduct29
    Created on : Jul 13, 2022, 11:09:50 PM
    Author     : Andreas PC
--%>
...
<body>
    ...
    <section id="prodetails" class="section-p1">
        <div class="single-pro-image">
            <img src="img/products/tro13/1.png" width="100%" id="MainImg" alt="">
            <div class="small-img-group">
                <div class="small-img-col">
                    <img src="img/products/tro13/1.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/products/tro13/2.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/products/tro13/3.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/products/tro13/4.png" width="100%" class="small-img" alt="">
                </div>
            </div>
        </div>
        ...
        <div class="single-pro-details">
            ...
            <h2>Floral Linen-blend Short</h2>
            <h3>$99</h3>
            <select>
            ...
            <Span>Shorts in an airy weave. High waist with covered elastication, discreet pockets in the side seams, an open back pocket and wide legs with short slits in the sides. Made from a linen and organic cotton blend, these shorts are part of our hand-painted meado.</Span>
        </div>
    </section>
