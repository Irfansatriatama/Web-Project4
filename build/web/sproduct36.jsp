<%-- 
    Document   : sproduct36
    Created on : Jul 13, 2022, 11:10:23 PM
    Author     : Andreas PC
--%>
...
<body>
    ...
    <section id="prodetails" class="section-p1">
        <div class="single-pro-image">
            <img src="img/products/acc/4.png" width="100%" id="MainImg" alt="">
        </div>
        ...
        <div class="single-pro-details">
            ...
            <span>--> "Balenciaga Hotels & Resorts" embroidered on upper</span><br>
            <span>--> Padded terry cloth footbed</span><br>
