<%-- 
    Document   : sproduct10
    Created on : Jul 13, 2022, 11:07:44 PM
    Author     : Andreas PC
--%>
...
<body>
    ...
    <section id="prodetails" class="section-p1">
        <div class="single-pro-image">
            <img src="img/products/shirt10/1.png" width="100%" id="MainImg" alt="">
            <div class="small-img-group">
                <div class="small-img-col">
                    <img src="img/products/shirt10/1.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/products/shirt10/2.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/products/shirt10/3.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/products/shirt10/4.png" width="100%" class="small-img" alt="">
                </div>
            </div>
        </div>
        ...
        <div class="single-pro-details">
            ...
            <h2>Oversize White Resort Shirt</h2>
            <h3>$69</h3>
            <select>
            ...
            <Span>CONSCIOUS CHOICE Short, oversized shirt in a softly draping viscose weave with a resort collar, yoke at the back and buttons down the front. Open chest pocket, low dropped shoulders and short, wide sleeves. Unlined.</Span>
        </div>
    </section>
