<%-- 
    Document   : sproduct22
    Created on : Jul 13, 2022, 11:08:39 PM
    Author     : Andreas PC
--%>
...
<body>
    ...
    <section id="prodetails" class="section-p1">
        <div class="single-pro-image">
            <img src="img/products/tro6/1.png" width="100%" id="MainImg" alt="">
            <div class="small-img-group">
                <div class="small-img-col">
                    <img src="img/products/tro6/1.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/products/tro6/2.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/products/tro6/3.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/products/tro6/4.png" width="100%" class="small-img" alt="">
                </div>
            </div>
        </div>
        ...
        <div class="single-pro-details">
            ...
            <Span>CONSCIOUS CHOICE Relaxed-fit dungarees in cotton twill with metal buttons at the sides, adjustable straps with metal fasteners, and a fake fly. Two-section chest pocket, diagonal side pockets and open back pockets. Hammer loop on one leg and a pocket with two compartments on the other.</Span>
        </div>
    </section>
