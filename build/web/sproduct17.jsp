<%-- 
    Document   : sproduct17
    Created on : Jul 13, 2022, 11:08:14 PM
    Author     : Andreas PC
--%>
...
<body>
    ...
    <section id="prodetails" class="section-p1">
        <div class="single-pro-image">
            <img src="img/products/tro1/1.png" width="100%" id="MainImg" alt="">
            <div class="small-img-group">
                <div class="small-img-col">
                    <img src="img/products/tro1/1.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/products/tro1/2.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/products/tro1/3.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/products/tro1/4.png" width="100%" class="small-img" alt="">
                </div>
            </div>
        </div>
        ...
        <div class="single-pro-details">
            ...
            <h2>Denim Blue Tapered Jogger</h2>
            <h3>$89</h3>
            <select>
            ...
            <Span>5-pocket joggers in stretch denim. Regular waist with covered elastication and a drawstring, and a zip fly with a button. Gently tapered legs with good room for movement over the thighs and knees, and covered elastication at the hems. Made using Lycra® Hybrid Technology for exceptional softness and comfort without compromising the authentic denim look.
            </Span>
        </div>
    </section>
    ...
    <section id="product1" class="section-p1">
        ...
        <div class="pro-container">
            <div class="pro" onclick="window.location.href='sproduct21.jsp'">
                <img src="img/products/tro5/1.png" alt="">
                <div class="des">
                    <span>FAE</span>
                    <h5>Light Grey Sport Short</h5>
                </div>
            </div>
            ...
            <div class="pro" onclick="window.location.href='sproduct19.jsp'">
                <img src="img/products/tro3/1.png" alt="">
                <div class="des">
                    <span>FAE</span>
                    <h5>White Relaxed Fit Trouser</h5>
                </div>
            </div>
