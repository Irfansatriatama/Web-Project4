<%-- 
    Document   : sproduct28
    Created on : Jul 13, 2022, 11:09:46 PM
    Author     : Andreas PC
--%>
...
<body>
    ...
    <section id="prodetails" class="section-p1">
        <div class="single-pro-image">
            <img src="img/products/tro12/1.png" width="100%" id="MainImg" alt="">
            <div class="small-img-group">
                <div class="small-img-col">
                    <img src="img/products/tro12/1.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/products/tro12/2.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/products/tro12/3.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/products/tro12/4.png" width="100%" class="small-img" alt="">
                </div>
            </div>
        </div>
        ...
        <div class="single-pro-details">
            ...
            <h2>Floral Wide Satin Trouser</h2>
            <h3>$99</h3>
            <select>
            ...
            <Span>CONSCIOUS CHOICE Trousers in satin with a loose yoke that covers one leg. High waist with covered elastication at the back, a partially concealed zip fly with a hook-and-eye fastener and wide, straight legs.</Span>
        </div>
    </section>
