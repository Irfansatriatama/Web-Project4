<%-- 
    Document   : sproduct21
    Created on : Jul 13, 2022, 11:08:36 PM
    Author     : Andreas PC
--%>
...
<body>
    ...
    <section id="prodetails" class="section-p1">
        <div class="single-pro-image">
            <img src="img/products/tro5/1.png" width="100%" id="MainImg" alt="">
            <div class="small-img-group">
                <div class="small-img-col">
                    <img src="img/products/tro5/1.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/products/tro5/2.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/products/tro6/3.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/products/tro5/4.png" width="100%" class="small-img" alt="">
                </div>
            </div>
        </div>
        ...
        <div class="single-pro-details">
            ...
            <Span>Sports shorts in stretch jersey with a crotch in ventilating mesh. Covered elastication and a drawstring at the waist, zipped side pockets for safe storage of items, and taped details at the sides. Straight, relaxed-fit legs that finish just below the knees.
            </Span>
        </div>
    </section>
